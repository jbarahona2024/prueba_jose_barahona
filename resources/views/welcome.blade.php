...
<div class="modal fade" id="modalregistrar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   ...
   <div class="p-5 table-responsive">
    <button class= "btn btn-success"  data-bs-toggle="modal" data-bs-target="#modalEditar"> Agregar usuario  </button>
...
<div class="modal fade" id="modalEditar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="mb-3">
    ...
    <input type="texto" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="txtApodo">

  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Contrasenha</label>
    <input type="texto" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="txtcontrasenha">
